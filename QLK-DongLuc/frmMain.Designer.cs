namespace QLK_DongLuc
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnTonDauKy = new DevExpress.XtraBars.BarButtonItem();
			this.btnGhiTonDauKy = new DevExpress.XtraBars.BarButtonItem();
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "Danh sách phiếu nhập";
			...
			// barButtonItem19
			// 
			this.barButtonItem19.Caption = "Nhập đơn giá";
			...
			// btnTonDauKy
			// 
			this.btnTonDauKy.Caption = "Tồn đầu kỳ";
			this.btnTonDauKy.Id = 86;
			this.btnTonDauKy.ImageIndex = 1;
			this.btnTonDauKy.Name = "btnTonDauKy";
			this.btnTonDauKy.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnTonDauKy_ItemClick);
			// 
			// btnGhiTonDauKy
			// 
			this.btnGhiTonDauKy.Caption = "Ghi lại tồn đầu kỳ";
			this.btnGhiTonDauKy.Id = 87;
			this.btnGhiTonDauKy.ImageIndex = 4;
			this.btnGhiTonDauKy.Name = "btnGhiTonDauKy";
			this.btnGhiTonDauKy.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.btnGhiTonDauKy_ItemClick);
			// 
			...
			this.ribbonPageGroup6.ItemLinks.Add(this.btnTonDauKy);
			this.ribbonPageGroup6.ItemLinks.Add(this.btnGhiTonDauKy);
		...
		private DevExpress.XtraBars.BarButtonItem btnTonDauKy;
		private DevExpress.XtraBars.BarButtonItem btnGhiTonDauKy;
